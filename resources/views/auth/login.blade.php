@extends('layouts.app') {{-- Assurez-vous que c'est le bon layout pour vos pages d'authentification --}}
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('login.post') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Entrez votre e-mail">
                            @error('email')
                        ...
                        <div class="text-center">
                            ...
                            @endif
                            <p class="mt-3 mb-0">Pas encore de compte ? <a href="{{ route('register') }}">Inscrivez-vous ici</a></p>
                        </div>
                    </form>
                </div>
            </div>

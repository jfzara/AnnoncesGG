...
<style>
    ...
    .form-check-label.custom-label-auth { /* Spécifique pour le label "Se souvenir de moi" */
        padding-top: 0; /* Pas besoin de padding-top pour les labels de checkbox */
    }
        ...
        <div class="col-md-6 col-lg-5">
            <div class="card custom-auth-card">
                <div class="card-header custom-gradient-header text-center">
                    <h4 class="mb-0"><i class="fas fa-sign-in-alt me-2"></i> {{ __('Connectez-vous à votre compte') }}</h4>
                </div>
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('login.post') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="email" type="email" class="form-control custom-form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Entrez votre adresse e-mail">
                            @error('email')
                        ...
                        <div class="mb-3">
                            ...
                            <input id="password" type="password" class="form-control custom-form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Entrez votre mot de passe">
                            @error('password')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-4 form-check">
                            ...
                            <label class="form-check-label custom-label-auth" for="remember">

...
<div id="divListe" class="d-flex flex-wrap justify-content-around mt-2 border-secondary">
    <div id="divAnnonce-15" class="m-3">
        <div class="card annonce">
            ...
            <div class="overflow-hidden text-right imageSize">
                <img alt="Image de " src="photos-annonce/test15.jpg" width="300" class="m-auto">
            </div>
            <div class="card-body pb-1">
                <h6 class="card-title"><a href="Annonce.php?id=15">Deux chateaux</a></h6>
                <div class="d-flex justify-content-between">
                    <div class="text-left">
                        <a href="mailto:test2@test.test">N2Test, P2Test</a>
                    </div>
                    <div class="text-right font-weight-bold"><span>500999.00 $</span></div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-between py-0">
                <div class="text-left">2021-05-15 00:45:30</div>
    ...
    <div id="divAnnonce-1" class="m-3">
        <div class="card annonce">
            ...
            <div class="overflow-hidden text-right imageSize">
                <img alt="Image de l'annonce 1" src="photos-annonce/test1.jpg" width="300" class="m-auto">
            </div>
            <div class="card-body pb-1">
    ...
    <div id="divAnnonce-8" class="m-3">
        <div class="card annonce">
            <div class="card-header d-flex justify-content-between py-1">
                ...
                <div class="text-right">À louer</div>
            </div>
            <div class="overflow-hidden text-right imageSize">
                <img alt="Image de l'annonce 8" src="photos-annonce/test8.jpg" width="300" class="m-auto">
            </div>
            <div class="card-body pb-1">
                <h6 class="card-title"><a href="Annonce.php?id=8">Bureau à louer</a></h6>
                <div class="d-flex justify-content-between">
                    <div class="text-left">
                        <a href="mailto:exemple8@test.test">Lucie Martin</a>
                    </div>
                    <div class="text-right font-weight-bold"><span>600.00 $/mois</span></div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-between py-0">
                <div class="text-left">2024-09-07 08:30:00</div>
                <div class="text-right font-italic">1</div>
            </div>
        </div>
    </div>
    ...
    <div id="divAnnonce-9" class="m-3">
        <div class="card annonce">
            ...
            <div class="overflow-hidden text-right imageSize">
                <img alt="Image de l'annonce 9" src="photos-annonce/test9.jpg" width="300" class="m-auto">
            </div>
            <div class="card-body pb-1">
                <h6 class="card-title"><a href="Annonce.php?id=9">Console de jeux vidéo</a></h6>
                <div class="d-flex justify-content-between">
                    <div class="text-left">
                        <a href="mailto:exemple9@test.test">Alain Dupuis</a>
                    </div>
                    <div class="text-right font-weight-bold"><span>300.00 $</span></div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-between py-0">
                <div class="text-left">2024-09-08 14:15:00</div>
                <div class="text-right font-italic">2</div>
            </div>
        </div>
    </div>
    ...
    <div id="divAnnonce-10" class="m-3">
        <div class="card annonce">
            ...
            <div class="overflow-hidden text-right imageSize">
                <img alt="Image de l'annonce 10" src="photos-annonce/test10.jpg" width="300" class="m-auto">
            </div>
            <div class="card-body pb-1">
                <h6 class="card-title"><a href="Annonce.php?id=10">Garde d'animaux</a></h6>
                <div class="d-flex justify-content-between">
                    <div class="text-left">
                        <a href="mailto:exemple10@test.test">Céline Lefèvre</a>
                    </div>
                    <div class="text-right font-weight-bold"><span>25.00 $/jour</span></div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-between py-0">
                <div class="text-left">2024-09-09 11:45:00</div>
                <div class="text-right font-italic">3</div>
            </div>
        </div>
    </div>

    <div id="divAnnonce-11" class="m-3">
        <div class="card annonce">
            <div class="card-header d-flex justify-content-between py-1">
                <div class="text-left">#11</div>
                <div class="text-right">À vendre</div>
            </div>
            <div class="overflow-hidden text-right imageSize">
                <img alt="Image de l'annonce 11" src="photos-annonce/test11.jpg" width="300" class="m-auto">
            </div>
            <div class="card-body pb-1">
                <h6 class="card-title"><a href="Annonce.php?id=11">Smartphone dernière génération</a></h6>
                <div class="d-flex justify-content-between">
                    <div class="text-left">
                        <a href="mailto:exemple11@test.test">Samuel Guérin</a>
                    </div>
                    <div class="text-right font-weight-bold"><span>750.00 $</span></div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-between py-0">
                <div class="text-left">2024-09-10 15:00:00</div>
                <div class="text-right font-italic">1</div>
            </div>
        </div>
    </div>

    <div id="divAnnonce-12" class="m-3">
        <div class="card annonce">
            <div class="card-header d-flex justify-content-between py-1">
            ...
            <div class="overflow-hidden text-right imageSize">
                <img alt="Image de l'annonce 12" src="photos-annonce/test12.jpg" width="300" class="m-auto">
            </div>
            <div class="card-body pb-1">
                <h6 class="card-title"><a href="Annonce.php?id=12">Chambre à louer</a></h6>
                <div class="d-flex justify-content-between">
                    <div class="text-left">
                        <a href="mailto:exemple12@test.test">Pauline Charpentier</a>
                    </div>
                    <div class="text-right font-weight-bold"><span>400.00 $/mois</span></div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-between py-0">
                <div class="text-left">2024-09-11 17:20:00</div>
                <div class="text-right font-italic">2</div>
            </div>
        </div>
    </div>

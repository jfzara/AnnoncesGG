        ...
        <div class="col-md-6">
            <div class="card custom-card">
                <div class="card-header text-center">
                    <h3 class="mb-0"><i class="fas fa-folder-plus me-2"></i> {{ __('Ajouter une nouvelle Catégorie') }}</h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('categories.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control custom-form-control @error('Description') is-invalid @enderror" id="Description" name="Description" value="{{ old('Description') }}" required maxlength="20" autofocus placeholder="Ex: Électronique, Immobilier...">
                            @error('Description')
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            <button type="submit" class="btn custom-primary-button">
                                <i class="fas fa-plus-circle me-2"></i> {{ __('Ajouter la Catégorie') }}
                            </button>
